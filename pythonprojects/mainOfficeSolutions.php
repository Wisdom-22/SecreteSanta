...
exec("python ./projectOfficeSolutions.py", $output, $resultcode);
...
$checkMainTable = "select * from officesolutionstable";
$resultMainTable = mysqli_query($con, $checkMainTable);

if(mysqli_num_rows($resultMainTable) != 0){
	$clearTable = "delete from officesolutionstable";
	...
	foreach($combined as $key => $value){
		...
		#echo $key."<br>";
		#echo $value ."<br>";
		$sqlInsert = "insert into officesolutionstable (id, description, prices, url) values('".$count."','".$key."','" .$value."','" .$url."')";
