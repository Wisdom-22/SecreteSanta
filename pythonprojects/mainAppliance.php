...
exec("python ./projectAppliance.py", $output, $resultcode);
...
if(mysqli_num_rows($resultMainTable) != 0){
	$clearTable = "delete from appliancetable";
	...
	foreach($combined as $key => $value){
		...
		#echo $key."<br>";
		#echo $value ."<br>";
		$sqlInsert = "insert into appliancetable (id, description, prices, url) values('".$count."','".$key."','" .$value."','" .$url."')";
