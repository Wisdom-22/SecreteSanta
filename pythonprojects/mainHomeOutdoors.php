...
exec("python ./projectHomeOutdoors.py", $output, $resultcode);
...
$checkMainTable = "select * from homeoutdoorstable";
$resultMainTable = mysqli_query($con, $checkMainTable);


if(mysqli_num_rows($resultMainTable) != 0){
	$clearTable = "delete from homeoutdoorstable";
	...
	foreach($combined as $key => $value){
		...
		#echo $key."<br>";
		#echo $value ."<br>";
		$sqlInsert = "insert into homeoutdoorstable (id, description, prices, url) values('".$count."','".$key."','" .$value."','" .$url."')";
