...
exec("python ./projectElectronics.py", $output, $resultcode);
...
if(mysqli_num_rows($resultMainTable) != 0){
	...
	foreach($combined as $key => $value){
		...
		#echo $key."<br>";
		#echo $value ."<br>";
		$sqlInsert = "insert into electronicstable (id, description, prices, url) values('".$count."','".$key."','" .$value."','" .$url."')";
